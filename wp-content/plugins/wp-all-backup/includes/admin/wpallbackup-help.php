...
<li class="page_item page-item-370"><a target="_blank" href="http://www.wpseeds.com/documentation/docs/wp-all-backup/pricing/">Pricing</a></li>
  ...
  <div class="panel panel-default">
    ...
    <div role="tabpanel" class="tab-pane" id="messages">
        <hr>
        <a href="http://www.wpseeds.com/documentation/docs/wp-all-backup/" target="_blank" class="btn btn-success btn" role="button"><?php  _e( 'WP ALL Backup Documentation', 'wpallbkp' );?></a>
        <div class="row">
